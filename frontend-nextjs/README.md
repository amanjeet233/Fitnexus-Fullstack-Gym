...
Make sure the backend is running before starting the frontend (for local dev).
Make sure this variable is set correctly in Netlify before deploying (for production).
