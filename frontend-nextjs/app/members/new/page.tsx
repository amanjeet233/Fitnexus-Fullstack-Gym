...
export default function NewMemberPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add custom username/password if provided
      if (formData.username.trim()) {
        memberData.username = formData.username.trim();
      }
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-4 border-t border-secondary-200">
                  <h3 className="text-lg font-semibold text-neo-700 mb-4 flex items-center gap-2">
                    <span className="text-xl">🔐</span>
                    Login Credentials (Optional)
                  </h3>
                  <p className="text-sm text-secondary-600 mb-4">
                    Leave blank to auto-generate, or set custom username/password
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                ...
                >
                  ...
                  >
                    <Button
                      type="submit"
                      disabled={loading}
                      className="h-12 bg-gradient-to-r from-neo-500 to-neo-600 hover:from-neo-600 hover:to-neo-700 shadow-neo-md hover:shadow-neo-lg active:shadow-neo-xl transition-all font-bold"
                    >
