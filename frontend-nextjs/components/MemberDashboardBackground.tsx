...
const MemberDashboardBackground = memo(function MemberDashboardBackground() {
  return (
    <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
      {/* Clean Member-Themed Gradient Background (Zero Yellow) */}
      <motion.div
      ...
      {/* Gym Icons - Soft Royal Blue / Slate Palettes */}
      {[
        ...
        { icon: User, size: 100, color: "rgba(14, 165, 233, 0.18)", x: "85%", y: "55%", delay: 5.5 },
        { icon: Calendar, size: 90, color: "rgba(2, 132, 199, 0.16)", x: "60%", y: "15%", delay: 6 },
